...
try:
    from lvm1 import __version__
except ModuleNotFoundError:
    from sdsstools import get_package_version
    __version__ = get_package_version(__file__, 'sdss-lvm1') or 'dev'
...
project = 'lvm1'
copyright = '{0}, {1}'.format('2021', 'gyoik kim')
author = 'gyoik kim'
...
.. |lvm1_version| replace:: {__version__}
"""
...
htmlhelp_basename = '{0}pdoc'.format('lvm1')
...
man_pages = [
    (master_doc, 'lvm1', u'{0} Documentation'.format(project),
     [author], 1)
]
...
if use_releases == 'yes':
    ...
    releases_github_path = 'sdss/lvm1'
